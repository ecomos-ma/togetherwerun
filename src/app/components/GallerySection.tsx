...
{
  src: "/assets/images/WhatsApp_Image_2026-09-25_at_17.11.51-1790352811379.jpeg",
  alt: 'Together We Run group run session',
  label: 'Sunday Drop'
},
{
  src: "/assets/images/WhatsApp_Image_2026-09-25_at_17.11.51__2_-1790352819575.jpeg",
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          ...
          <div
            ...
            style={{ transitionDelay: revealed ? `${i * 80}ms` : '0ms' }}>
              ...
              alt={img.alt}
              fill
              className={`object-cover ${img.label === 'Evening Run' ? 'object-[center_70%]' : ''}`}
