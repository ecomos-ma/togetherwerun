      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {runTypes.map((run, i) => (
            ...
            >
              {/* Coming Soon badge for Evening Runs */}
              {run.tag === 'Evening' && (
                <div className="flex justify-center pt-4 px-6">
                  <span className="inline-flex items-center gap-1.5 bg-accent/15 text-accent text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-full border border-accent/25">
